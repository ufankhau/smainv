...
def send_status(timestamp, _):
    ...
    sma_invdata["Energy Today"] = invdata["energy_today"]
    sma_invdata["Energy Total"] = invdata["energy_total"]
    ...
    sma_invdata["Grid Frequency"] = invdata["frequency"]
